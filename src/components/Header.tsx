        ...
        <nav className="glass backdrop-blur-xl bg-white/90 border border-white/30 rounded-3xl px-6 lg:px-8 shadow-xl">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/" className="text-gray-700 hover:text-[#63316b] font-medium transition-colors">Home</Link>
              
              {/* Services Dropdown */}
              <div className="relative group">
                <button 
                  className="flex items-center space-x-1 text-gray-700 hover:text-[#63316b] font-medium transition-colors"
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <button className="bg-[#63316b] text-white px-6 py-2 rounded-full font-medium hover:bg-[#63316b]/90 transition-all duration-300 shadow-lg hover:shadow-xl">
                Book Appointment
              </button>
            </div>
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="md:hidden border-t border-white/20 mt-4 pt-4 pb-6">
              <div className="space-y-4">
                <Link to="/" className="block text-gray-700 hover:text-[#63316b] font-medium py-2">Home</Link>
                
                {/* Mobile Services */}
                <div className="space-y-2">
                  <div className="text-gray-900 font-semibold py-2 border-b border-white/20">Treatments</div>
                  {services.map((service, index) => (
                    <Link
                      key={index}
                      to={service.path}
                      className="block text-gray-700 hover:text-[#63316b] font-medium py-2 pl-4"
                    >
                      {service.name}
                    </Link>
                  ))}
                ...
                <div className="pt-4 border-t border-white/20">
                  ...
                  <button className="w-full bg-[#63316b] text-white px-6 py-3 rounded-full font-medium shadow-lg">
                    Book Appointment
                  </button>
                </div>
              </div>
