            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  A long-lasting and immovable remedy for individuals with
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-centre mt-12">
            <p className="text-lg text-gray-600 mb-6">
              Full arch implants provide a permanent solution for missing teeth,
              offering natural-looking results and restored functionality.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                replaces the root of a missing tooth. It bonds with your jawbone
                over time, creating a strong foundation for a new tooth or
                bridge.
              </p>

              <p className="text-lg text-gray-600 leading-relaxed">
                Full arch implants use multiple strategically placed implants to
                support an entire arch of replacement teeth, providing a
                permanent and natural-looking solution for extensive tooth loss.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {implantTypes.map((type, index) => (
              <div
                key={type.id}
                className="group relative bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-[#63316b]/20 transition-all duration-300"
              >
                <div className="space-y-6">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-6 text-white">
            ...
            <p className="text-xl opacity-90">
              Most people in good health are great candidates. Come in for your
              FREE consultation — let's build your personalised treatment plan.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm">
                available via Chrysalis Finance
              </p>
            </div>
